...
- Records: `200`.
- Groups: `50`.
- Candidate score: `0.269007`.
- fp16 Shared-KV reference score: `0.271869`.
- Score delta: `-0.002862`.
- Candidate avg latency: `2.508033s`.
- Reference avg latency: `0.452763s`.
- Candidate/reference latency ratio: `5.54x`.
- Score mismatches: `11`.
- Prediction mismatches: `25`.

## Storage

- Prefix-table saving vs fp16 Shared-KV: `65.35%`.
- Shared-total saving vs fp16 Shared-KV: `64.72%`.
- Candidate shared total bytes: `36729206144`.
...
- index `925`: candidate `0.18181818181818182` vs reference `0.7499999999999999`
